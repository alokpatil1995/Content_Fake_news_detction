...
def prediction():
    if request.method =="POST":
        ...
        if predict== 0 :
           return render_template("prediction.html", prediction_text="News Content is -> REAL i.e {}".format(predict))
        elif predict== 1 :
           return render_template("prediction.html", prediction_text="News Content is -> FALSE  {}".format(predict))
        else:
